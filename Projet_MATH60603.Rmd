...
plot_usmap(regions="state", data=state.churn, values = "pct_perte.client", color="blue")+
  scale_fill_continuous(low = "white", high = "blue", name = "pct_perte.client")+ 
  labs(title = "Perte clientèle États-Unis", subtitle = "Opérateur Orange télécom")+
  theme(legend.position = "right")

```
On constate que l'état du Texas est l'état ayant perdu le plus de clientèle
